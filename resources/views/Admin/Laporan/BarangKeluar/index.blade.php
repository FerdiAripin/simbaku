...
@section('scripts')
    <script>
        ...
        function print() {
            ...
            if (tglawal != '' && tglakhir != '') {
                window.open(
                    "{{ route('lap-bk.print') }}?tglawal=" + tglawal + "&tglakhir=" + tglakhir + "&jenis=" + jenis,
                    '_blank'
                );
            } else {
                swal({
                    ...
                    if (value == true) {
                        window.open(
                            "{{ route('lap-bk.print') }}?jenis=" + jenis,
                            '_blank'
                        );
                        swal.close();
                    }
        ...
        function pdf() {
            ...
            if (tglawal != '' && tglakhir != '') {
                window.open(
                    "{{ route('lap-bk.pdf') }}?tglawal=" + tglawal + "&tglakhir=" + tglakhir + "&jenis=" + jenis,
                    '_blank'
                );
            } else {
                swal({
