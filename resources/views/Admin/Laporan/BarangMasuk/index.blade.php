...
@section('scripts')
    <script>
        ...
        function print() {
            ...
            if (tglawal != '' && tglakhir != '') {
                window.open(
                    "{{ route('lap-bm.print') }}?tglawal=" + tglawal + "&tglakhir=" + tglakhir + "&jenis=" + jenis,
                    '_blank'
                );
            } else {
                swal({
                    ...
                    if (value == true) {
                        window.open(
                            "{{ route('lap-bm.print') }}?jenis=" + jenis,
                            '_blank'
                        );
                        swal.close();
                    }
        ...
        function pdf() {
            ...
            if (tglawal != '' && tglakhir != '') {
                window.open(
                    "{{ route('lap-bm.pdf') }}?tglawal=" + tglawal + "&tglakhir=" + tglakhir + "&jenis=" + jenis,
                    '_blank'
                );
            } else {
                swal({
