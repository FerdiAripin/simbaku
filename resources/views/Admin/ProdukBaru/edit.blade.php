    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Ubah Produk</h6><button onclick="resetU()" aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="form-group">
                            <label for="kodeU" class="form-label">Kode Produk <span class="text-danger">*</span></label>
                            <input type="text" name="kodeU" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="namaU" class="form-label">Nama Produk <span class="text-danger">*</span></label>
                            <input type="text" name="namaU" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="kategoriU" class="form-label">Kategori</label>
                            <select name="kategoriU" class="form-control">
...
<script>
    ...
    function submitFormU() {
        ...
        const kode = $("input[name='kodeU']").val();
        const nama = $("input[name='namaU']").val();
        const kategori = $("select[name='kategoriU']").val();
        const stok = $("input[name='stokU']").val();
        ...
        $.ajax({
            type: 'POST',
            url: "{{url('admin/produk_baru/proses_ubah')}}/" + id,
            processData: false,
            contentType: false,
            dataType: 'json',
            data: fd,
    ...
    function resetValidU() {
        ...
        $("select[name='kategoriU']").removeClass('is-invalid');
