    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Tambah Produk</h6><button onclick="reset()" aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" name="stok" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
...
<script>
    function checkForm() {
        ...
        resetValid();
        if (kode == "") {
            validasi('Kode Produk wajib di isi!', 'warning');
            $("input[name='kode']").addClass('is-invalid');
            setLoading(false);
            return false;
        } else if (nama == "") {
            validasi('Nama Produk wajib di isi!', 'warning');
    ...
    function resetValid() {
        ...
        $("select[name='kategori']").removeClass('is-invalid');
